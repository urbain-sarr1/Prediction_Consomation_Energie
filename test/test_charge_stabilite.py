...
(10, 20, 50 puis 100 requêtes) afin d'identifier à partir de quel seuil les performances 
...
prolongé de l'API sur plusieurs centaines de requêtes afin de détecter d'éventuelles dégradations 
progressives des performances ou une augmentation anormale de la latence dans le temps. 
Des points de contrôle intermédiaires permettent également de suivre l'évolution du système 
...
# ============================================================
# LOAD RAMP TEST
# Volumes réduits : 10, 20, 50, 100 (au lieu de 10, 50, 100, 200, 500)
# Evite le rate limiting du plan gratuit Render
# ============================================================
...
# ============================================================
# SOAK TEST
# Réduit à 200 requêtes (au lieu de 2000)
# Checkpoint tous les 50 (au lieu de 500)
# ============================================================

def run_soak_test(n=200):
